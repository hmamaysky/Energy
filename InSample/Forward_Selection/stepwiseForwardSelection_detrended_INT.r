...
dir <- "C:/Users/13917/Desktop/CBS/Energy-RA/External Variables In sample results/table 4_INT"
setwd(dir)
...
subset.prices <- dplyr::select(data.prices, c(FutRet_t4, FutRet_t8, DSpot_t4, DSpot_t8, DOilVol_t4, DOilVol_t8, 
                                              ...
                                              BEME, Mom, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt, INT))
...
subset.physical <- dplyr::select(data.physical, c(DInv_t4, DInv_t8, DProd_t4, DProd_t8, FutRet, DSpot, DOilVol, xomRet, bpRet, rdsaRet,
                                                  ...
                                                  DolBeta, InflaBeta, HedgPres, liquidity, OpenInt, INT))
...
toLag <- c("FutRet", "DSpot", "DOilVol", "OilVol", 
           ...
           "vix_diff", "sdf_fullSample", "PCAsent", "PCAfreq", "PCAall","BEME", "Mom", "BasMom", "DolBeta", "InflaBeta", "HedgPres", "liquidity", "OpenInt", "INT")
...
subset <- dplyr::select(detrended.prices, 
                        c(FutRet_t4, 
                          ...
                          PCAsent, PCAfreq, PCAall,BEME, Mom, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt, INT))

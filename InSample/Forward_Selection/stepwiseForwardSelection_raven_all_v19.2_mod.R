...
#dir <- "A:/j1fmd01/Energy-015cb58076dcd3385f5c7a8fb29aa516000e4ba5/InSample/Forward Selection/"
#setwd(dir)
setwd("~/Downloads")
# ------------------------------------------------------------------------
...
subset.prices <- dplyr::select(data.prices, c(FutRet_t4, FutRet_t8, DSpot_t4, DSpot_t8, DOilVol_t4, DOilVol_t8, 
                                              ...
                                              entropy, sCo, fCo, sGom, fGom, sEnv, fEnv, sEpg, fEpg, sBbl, fBbl, ovx_diff, sdf_fullSample,
                                              sRpc, fRpc, sEp, fEp, VIX, vix_diff, PCAsent, PCAfreq, PCAall,
                                              BEME, Mom, economic_growth, product_prices, gov_budget, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset.physical <- dplyr::select(data.physical, c(DInv_t4, DInv_t8, DProd_t4, DProd_t8, FutRet, DSpot, DOilVol,xomRet, bpRet, rdsaRet,
                                                  ...
                                                  entropy, sCo, fCo, sGom, fGom, sEnv, fEnv, sEpg, fEpg, sBbl, fBbl, sRpc, fRpc, sEp, fEp, ovx_diff, sdf_fullSample,
                                                  VIX, vix_diff, PCAsent, PCAfreq, PCAall, BEME, Mom, economic_growth, product_prices, gov_budget, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
toLag <- c("FutRet", "DSpot", "DOilVol", "OilVol", 
           ...
           "entropy", "sCo", "fCo", "sGom", "fGom", "sEnv", "fEnv", "sEpg", "ovx_diff", "sdf_fullSample",
           "fEpg", "sBbl", "fBbl", "sRpc", "fRpc", "sEp", "fEp", "VIX", "vix_diff", 
           "PCAsent", "PCAfreq", "PCAall", "BEME", "Mom", "economic_growth", "product_prices", "gov_budget", "BasMom", "DolBeta", "InflaBeta", "HedgPres", "liquidity", "OpenInt")
...
#                           DProd, tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_4wk, VIX, ovx_diff, vix_diff, sdf_fullSample,
#                           BEME, Mom, PositiveWords, NegativeWords, TotalWords, Tone, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
# 
# depVar <- "FutRet_t4"
# horizon <- 4
# 
...
subset <- dplyr::select(detrended.prices, 
                        c(FutRet_t8, 
                          ...
                          fRpc, sEp, fEp, VIX, vix_diff, PCAsent, PCAfreq, PCAall, ovx_diff, sdf_fullSample,
                          BEME, Mom, economic_growth, product_prices, gov_budget, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
#                           sp500Ret, StkIdx, basis, WIPI_4wk, VIX, ovx_diff, vix_diff, sdf_fullSample,
#                           BEME, Mom, PositiveWords, NegativeWords, TotalWords, Tone, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
# 
# depVar <- "DSpot_t4"
# horizon <- 4
...
subset <- dplyr::select(detrended.prices,
                        c(DSpot_t8, 
                          DSpot, FutRet, DOilVol,  OilVol, DInv, DProd, tnote_10y, DFX, 
                          sp500Ret, StkIdx, basis, WIPI_8wk, artcount, entropy, sCo, fCo, ovx_diff, sdf_fullSample,
                          sGom, fGom, sEnv, fEnv, sEpg, fEpg, sBbl, fBbl, sRpc, 
...
#                          sp500Ret, StkIdx, basis, WIPI_4wk, VIX, ovx_diff, vix_diff, sdf_fullSample,
#                          PCAsent, PCAfreq, PCAall,BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
#                           tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_4wk, VIX, ovx_diff, vix_diff, sdf_fullSample,
#                           BEME, Mom, PositiveWords, NegativeWords, TotalWords, Tone, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
# 
# depVar <- "DProd_t4"
# horizon <- 4
...
tab_model(FutRet_t8.0, FutRet_t8.1, FutRet_t8.2, FutRet_t8.3, FutRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_FutRet_8wks.doc")
...
tab_model(DSpot_t8.0, DSpot_t8.1, DSpot_t8.2, DSpot_t8.3, DSpot_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_DSpot_8wks.doc")
...
tab_model(DOilVol_t8.0, DOilVol_t8.1, DOilVol_t8.2, DOilVol_t8.3, DOilVol_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_DOilVol_8wks.doc")
...
tab_model(xomRet_t8.0, xomRet_t8.1, xomRet_t8.2, xomRet_t8.3, xomRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_xomRet_8wks.doc")
...
tab_model(bpRet_t8.0, bpRet_t8.1, bpRet_t8.2, bpRet_t8.3, bpRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_bpRet_8wks.doc")
...
tab_model(rdsaRet_t8.0, rdsaRet_t8.1, rdsaRet_t8.2, rdsaRet_t8.3, rdsaRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_rdsaRet_8wks.doc")
...
tab_model(DInv_t8.0, DInv_t8.1, DInv_t8.2, DInv_t8.3, DInv_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_DInv_8wks.doc")
...
tab_model(DProd_t8.0, DProd_t8.1, DProd_t8.2, DProd_t8.3, DProd_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "InSample/Forward Selection/raven_all_v19.2_mod/forwardSelection_DProd_8wks.doc")
...
#           vcov.fun = "vcovHAC", file = "Ioannis/forwardSelection_FutRet_4wks.doc")
# 
# # Spot price changes forward selection regressions results with staggered risk premia measures
...
#           vcov.fun = "vcovHAC", file = "Ioannis/forwardSelection_DSpot_4wks.doc")
# 
# # Oil price volatility changes forward selection regressions results with staggered risk premia measures
...
# #           vcov.fun = "vcovHAC", file = "Ioannis/forwardSelection_DOilVol_4wks.doc")
# 
# # Exxon stock returns changes forward selection regressions results with staggered risk premia measures
...
#           vcov.fun = "vcovHAC", file = "Ioannis/forwardSelection_xomRet_4wks.doc")
# 
# # BP stock returns changes forward selection regressions results with staggered risk premia measures
...
#           vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_bpRet_4wks.doc")
# 
# # Royal Dutch Shell stock returns changes forward selection regressions results with staggered risk premia measures
...
#           vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_rdsaRet_4wks.doc")
# 
# # Oil inventory changes forward selection regressions results with staggered risk premia measures
...
#           vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_DInv_4wks.doc")
# 
# # Oil production changes forward selection regressions results with staggered risk premia measures
...
#           vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_DProd_4wks.doc")

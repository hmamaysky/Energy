...
dir <- "C:/Users/13917/Desktop/CBS/Energy-RA/External Variables In sample results/table 4_opu"
setwd(dir)
...
data.prices <- read.dta13("C:/Users/13917/Desktop/CBS/Energy-RA/Fwd_ In sample results/transformed_data_prices_v19.3_mod_full_sample.dta")
...
# Add external opu_index variable
subset.prices <- dplyr::select(data.prices, c(FutRet_t4, FutRet_t8, DSpot_t4, DSpot_t8, DOilVol_t4, DOilVol_t8, 
                                              ...
                                              BEME, Mom, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt, opu_index))
...
# Includes risk premia measures and VIX
data.physical <- read.dta13("C:/Users/13917/Desktop/CBS/Energy-RA/Fwd_ In sample results/transformed_data_physical_v19.3_mod_full_sample.dta")
# Strip out the suffix we added for indicating when it's calculated
...
subset.physical <- dplyr::select(data.physical, c(DInv_t4, DInv_t8, DProd_t4, DProd_t8, FutRet, DSpot, DOilVol, xomRet, bpRet, rdsaRet,
                                                  ...
                                                  DolBeta, InflaBeta, HedgPres, liquidity, OpenInt, opu_index))
...
toLag <- c("FutRet", "DSpot", "DOilVol", "OilVol", 
           ...
           "vix_diff", "sdf_fullSample", "PCAsent", "PCAfreq", "PCAall","BEME", "Mom", "BasMom", "DolBeta", "InflaBeta", "HedgPres", "liquidity", "OpenInt", "opu_index")
...
subset <- dplyr::select(detrended.prices, 
                        c(FutRet_t4, 
                          ...
                          PCAsent, PCAfreq, PCAall,BEME, Mom, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt, opu_index))
...
tab_model(FutRet_t4.0, FutRet_t4.1, FutRet_t4.2, FutRet_t4.3, FutRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "forwardSelection_FutRet_4wks.doc")
...
tab_model(DSpot_t4.0, DSpot_t4.1, DSpot_t4.2, DSpot_t4.3, DSpot_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "forwardSelection_DSpot_4wks.doc")
...
#           vcov.fun = "vcovHAC", file = "forwardSelection_DOilVol_4wks.doc")
...
tab_model(xomRet_t4.0, xomRet_t4.1, xomRet_t4.2, xomRet_t4.3, xomRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "forwardSelection_xomRet_4wks.doc")
...
tab_model(bpRet_t4.0, bpRet_t4.1, bpRet_t4.2, bpRet_t4.3, bpRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "forwardSelection_bpRet_4wks.doc")
...
tab_model(rdsaRet_t4.0, rdsaRet_t4.1, rdsaRet_t4.2, rdsaRet_t4.3, rdsaRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "forwardSelection_rdsaRet_4wks.doc")
...
tab_model(DInv_t4.0, DInv_t4.1, DInv_t4.2, DInv_t4.3, DInv_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "forwardSelection_DInv_4wks.doc")
...
tab_model(DProd_t4.0, DProd_t4.1, DProd_t4.2, DProd_t4.3, DProd_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "forwardSelection_DProd_4wks.doc")
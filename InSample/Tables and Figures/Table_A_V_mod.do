...
use "C:\Users\j1kxb09\Dropbox (Fed Reserve KC)\Downloads\transformed_data_prices_v19.2_mod.dta"


tsset date_Fri, delta(7 days)

**** FutRet
eststo m1: newey FutRet_t8_Fri L8.FutRet_Fri L8.basis_Fri L8.Mom_monthly L8.PCAall_Fri L8.entropy_Fri L8.sGom_Fri L8.fBbl_Fri L8.fRpc_Fri, lag(6) force

*text
test L8.PCAall_Fri L8.entropy_Fri L8.sGom_Fri L8.fBbl_Fri L8.fRpc_Fri
mat t1= r(F)
mat p1= r(p)
*nontext
test L8.basis_Fri L8.Mom_monthly
mat t2= r(F)
mat p2= r(p)
*all
test L8.basis_Fri L8.Mom_monthly L8.PCAall_Fri L8.entropy_Fri L8.sGom_Fri L8.fBbl_Fri L8.fRpc_Fri
mat t3= r(F)
mat p3= r(p)
...
**** xomRet
eststo m4: newey xomRet_t8_Fri L8.xomRet_Thu L8.DInv_Wed L8.BEME_monthly L8.entropy_Fri L8.sEpg_Fri L8.fBbl_Fri L8.sRpc_Fri L8.sEp_Fri, lag(6) force

*text
test L8.entropy_Fri L8.sEpg_Fri L8.fBbl_Fri L8.sRpc_Fri L8.sEp_Fri
mat t1= r(F)
mat p1= r(p)
*nontext
test L8.DInv_Wed L8.BEME_monthly
mat t2= r(F)
mat p2= r(p)
*all
test L8.DInv_Wed L8.BEME_monthly L8.entropy_Fri L8.sEpg_Fri L8.fBbl_Fri L8.sRpc_Fri L8.sEp_Fri
mat t3= r(F)
mat p3= r(p)
*record the results in a matrix for the purpose of creating a table in the end
mat m4= t1,t2,t3
...
use "C:\Users\j1kxb09\Dropbox (Fed Reserve KC)\Downloads\transformed_data_physical_v19.2_mod.dta"

tsset date_Tue, delta(7 days)

**** DInv 

eststo m7: newey DInv_t8_Wed L8.DInv_Wed L8.tnote_10y_Tue L8.BasMom_monthly L8.entropy_Tue L8.sGom_Tue L8.fRpc_Tue L8.sEp_Tue L8.fEp_Tue , lag(6) force
...
mat p1= r(p)
*nontext
test L8.tnote_10y_Tue L8.BasMom_monthly
mat t2= r(F)
mat p2= r(p)
*all
test L8.tnote_10y_Tue L8.BasMom_monthly L8.entropy_Tue L8.sGom_Tue L8.fRpc_Tue L8.sEp_Tue L8.fEp_Tue
mat t3= r(F)
mat p3= r(p)
*record the results in a matrix for the purpose of creating a table in the end
mat m7= t1,t2,t3
...
esttab m* using C:\Users\j1kxb09\Downloads\TableAV\Table_A_V.rtf, replace star(* 0.10 ** 0.05 *** 0.01) cells(m(star pvalue(pval) fmt(%9.2f))) ///

...
data.prices <- read.dta13("A:/j1fmd01/Energy-015cb58076dcd3385f5c7a8fb29aa516000e4ba5/data/transformed_data_prices_v19_restricted_sample.dta") 
...
# Includes risk premia measures and VIX
data.physical <- read.dta13("A:/j1fmd01/Energy-015cb58076dcd3385f5c7a8fb29aa516000e4ba5/data/transformed_data_physical_v19_restricted_sample.dta") 
...
tab_model(FutRet_8wk$sdcoef, DSpot_8wk$sdcoef, DOilVol_8wk$sdcoef, xomRet_8wk$sdcoef, bpRet_8wk$sdcoef, rdsaRet_8wk$sdcoef, DInv_8wk$sdcoef, DProd_8wk$sdcoef, 
          ...
          vcov.fun = "vcovHAC", file = "all_restricted/forwardSelection_8wks_allVars_new.doc")
...
tab_model(FutRet_8wk$depVar.lagDepVar, DSpot_8wk$depVar.lagDepVar, DOilVol_8wk$depVar.lagDepVar, xomRet_8wk$depVar.lagDepVar, 
          ...
          vcov.fun = "vcovHAC", file = "all_restricted/forwardSelection_8wks_AR1_new.doc")
...
#           vcov.fun = "vcovHAC", file = "all_restricted/forwardSelection_4wks_allVars_new.doc")
# 
# # Regressions of dependent variables on lagged dependent variables 
...
#           show.ci = F, show.p = F, p.style = "star",  title = "Dependent variables on lagged dependent variable coefficients",
#           vcov.fun = "vcovHAC", file = "all_restricted/forwardSelection_4wks_AR1_new.doc")

# Adjusted R-Squared
pdf("all_restricted/Monte_Carlo_Exhibits_fs_rsq_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
# T-Statistics
pdf("all_restricted/Monte_Carlo_Exhibits_fs_tstat_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("all_restricted/Fig3.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("all_restricted/Fig4.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")

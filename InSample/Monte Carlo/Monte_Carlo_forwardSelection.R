...
tab_model(FutRet_8wk$sdcoef, DSpot_8wk$sdcoef, DOilVol_8wk$sdcoef, xomRet_8wk$sdcoef, bpRet_8wk$sdcoef, rdsaRet_8wk$sdcoef, DInv_8wk$sdcoef, DProd_8wk$sdcoef, 
          ...
          vcov.fun = "vcovHAC", file = "20220227/forwardSelection_8wks_allVars_new.doc")
...
tab_model(FutRet_8wk$depVar.lagDepVar, DSpot_8wk$depVar.lagDepVar, DOilVol_8wk$depVar.lagDepVar, xomRet_8wk$depVar.lagDepVar, 
          ...
          vcov.fun = "vcovHAC", file = "20220227/forwardSelection_8wks_AR1_new.doc")
...
tab_model(FutRet_4wk$sdcoef, DSpot_4wk$sdcoef, xomRet_4wk$sdcoef, bpRet_4wk$sdcoef, rdsaRet_4wk$sdcoef, DInv_4wk$sdcoef, DProd_4wk$sdcoef, 
          ...
          vcov.fun = "vcovHAC", file = "20220227/forwardSelection_4wks_allVars_new.doc")
...
tab_model(FutRet_4wk$depVar.lagDepVar, DSpot_4wk$depVar.lagDepVar, xomRet_4wk$depVar.lagDepVar, 
          ...
          show.ci = F, show.p = F, p.style = "star",  title = "Dependent variables on lagged dependent variable coefficients",
          vcov.fun = "vcovHAC", file = "20220227/forwardSelection_4wks_AR1_new.doc")

# Adjusted R-Squared
pdf("20220227/Monte_Carlo_Exhibits_fs_rsq_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
# T-Statistics
pdf("20220227/Monte_Carlo_Exhibits_fs_tstat_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("20220227/Fig3.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("20220227/Fig4.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")

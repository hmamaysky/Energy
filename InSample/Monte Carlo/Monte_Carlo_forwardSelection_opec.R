...
dir <- "file_path/InSample/Monte Carlo/"
setwd(dir)
...
subset.prices <- dplyr::select(data.prices, c(FutRet_t4, FutRet_t8, DSpot_t4, DSpot_t8, DOilVol_t4, DOilVol_t8, 
                                              ...
                                              DProd, tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_4wk, WIPI_8wk, trend,
                                              VIX, vix_diff,
...
subset.physical <- dplyr::select(data.physical, c(DInv_t4, DInv_t8, DProd_t4, DProd_t8, FutRet, DSpot, DOilVol,xomRet, bpRet, rdsaRet,
                                                  ...
                                                  VIX, vix_diff, BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.prices, 
                        c(FutRet_t4, 
                          ...
                          DProd, tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_4wk, VIX, vix_diff,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.prices, 
                        c(FutRet_t8, 
                          FutRet, DSpot, DOilVol,  OilVol, DInv, 
                          DProd, tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_8wk, VIX, vix_diff,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.prices,
                        c(DSpot_t4, 
                          ...
                          sp500Ret, StkIdx, basis, WIPI_4wk, VIX, vix_diff,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.prices,
                        c(DSpot_t8, 
                          DSpot, FutRet, DOilVol,  OilVol, DInv, DProd, tnote_10y, DFX, 
                          sp500Ret, StkIdx, basis, WIPI_8wk, VIX, vix_diff,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.physical,
                        c(DProd_t4, 
                          ...
                          tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_4wk, VIX, vix_diff,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.physical,
                        c(DProd_t8,
                          DProd, FutRet, DSpot, DOilVol,  OilVol, DInv, 
                          tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_8wk, VIX, vix_diff,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
tab_model(FutRet_8wk$sdcoef, DSpot_8wk$sdcoef, DOilVol_8wk$sdcoef, xomRet_8wk$sdcoef, bpRet_8wk$sdcoef, rdsaRet_8wk$sdcoef, DInv_8wk$sdcoef, DProd_8wk$sdcoef, 
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_8wks_allVars_new.doc")
...
tab_model(FutRet_8wk$depVar.lagDepVar, DSpot_8wk$depVar.lagDepVar, DOilVol_8wk$depVar.lagDepVar, xomRet_8wk$depVar.lagDepVar, 
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_8wks_AR1_new.doc")
...
tab_model(FutRet_4wk$sdcoef, DSpot_4wk$sdcoef, xomRet_4wk$sdcoef, bpRet_4wk$sdcoef, rdsaRet_4wk$sdcoef, DInv_4wk$sdcoef, DProd_4wk$sdcoef, 
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_4wks_allVars_new.doc")
...
tab_model(FutRet_4wk$depVar.lagDepVar, DSpot_4wk$depVar.lagDepVar, xomRet_4wk$depVar.lagDepVar, 
          ...
          show.ci = F, show.p = F, p.style = "star",  title = "Dependent variables on lagged dependent variable coefficients",
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_4wks_AR1_new.doc")

# Adjusted R-Squared
pdf("opec/Monte_Carlo_Exhibits_fs_rsq_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")

figure <- ggarrange(FutRet_4wk$plot.rsq, FutRet_8wk$plot.rsq, DSpot_4wk$plot.rsq, DSpot_8wk$plot.rsq, DOilVol_8wk$plot.rsq, nrow = 3, ncol = 2)
...
# T-Statistics
pdf("opec/Monte_Carlo_Exhibits_fs_tstat_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("opec/Fig3.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("opec/Fig4.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")

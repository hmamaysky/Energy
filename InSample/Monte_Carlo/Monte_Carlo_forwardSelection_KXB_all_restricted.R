...
tab_model(FutRet_8wk$sdcoef, DSpot_8wk$sdcoef, DOilVol_8wk$sdcoef, xomRet_8wk$sdcoef, bpRet_8wk$sdcoef, rdsaRet_8wk$sdcoef, DInv_8wk$sdcoef, DProd_8wk$sdcoef, 
          ...
          vcov.fun = "vcovHAC", file = "data/all_restricted/forwardSelection_8wks_allVars_new.doc")
...
tab_model(FutRet_8wk$depVar.lagDepVar, DSpot_8wk$depVar.lagDepVar, DOilVol_8wk$depVar.lagDepVar, xomRet_8wk$depVar.lagDepVar, 
          ...
          vcov.fun = "vcovHAC", file = "data/all_restricted/forwardSelection_8wks_AR1_new.doc")
...
# Adjusted R-Squared
pdf("data/all_restricted/Monte_Carlo_Exhibits_fs_rsq_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
# T-Statistics
pdf("data/all_restricted/Monte_Carlo_Exhibits_fs_tstat_new.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("data/all_restricted/Fig3.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")
...
pdf("data/all_restricted/Fig4.pdf", paper = "letter", width = 7.5, height = 10, family = "Times")

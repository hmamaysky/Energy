...
data.prices <- read.dta13("file_path/data/transformed_data_prices_v19_opec.dta") 
...
subset.prices <- dplyr::select(data.prices, c(FutRet_t4, FutRet_t8, DSpot_t4, DSpot_t8, DOilVol_t4, DOilVol_t8, 
                                              ...
                                              DProd, tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_4wk, WIPI_8wk, trend, VIX, ovx_diff, vix_diff, sdf_fullSample, PCAsent, PCAfreq, PCAall,
                                              BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
# Includes risk premia measures and VIX
data.physical <- read.dta13("file_path/data/transformed_data_physical_v19_opec.dta") 
# Strip out the suffix we added for indicating when it's calculated
...
subset.physical <- dplyr::select(data.physical, c(DInv_t4, DInv_t8, DProd_t4, DProd_t8, FutRet, DSpot, DOilVol, xomRet, bpRet, rdsaRet,
                                                  OilVol, DInv, DProd, tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_4wk, WIPI_8wk, trend, 
                                                  VIX, ovx_diff, vix_diff, sdf_fullSample, BEME, Mom, opec, BasMom, 
...
toLag <- c("FutRet", "DSpot", "DOilVol", "OilVol", 
           ...
           "VIX", "ovx_diff", 
           "vix_diff", "sdf_fullSample", "BEME", "Mom", "opec", "BasMom", "DolBeta", "InflaBeta", "HedgPres", "liquidity", "OpenInt")
...
subset <- dplyr::select(detrended.prices,
                        c(FutRet_t8, 
                          FutRet, DSpot, DOilVol,  OilVol, DInv, 
                          DProd, tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_8wk, VIX, ovx_diff, vix_diff, sdf_fullSample,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.prices,
                        c(DSpot_t8, 
                          DSpot, FutRet, DOilVol,  OilVol, DInv, DProd, tnote_10y, DFX, 
                          sp500Ret, StkIdx, basis, WIPI_8wk, VIX, ovx_diff, vix_diff, sdf_fullSample,
                         BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset <- dplyr::select(detrended.physical, 
                        c(DProd_t8, 
                          DProd, FutRet, DSpot, DOilVol,  OilVol, DInv, 
                          tnote_10y, DFX, sp500Ret, StkIdx, basis, WIPI_8wk, VIX, ovx_diff, vix_diff, sdf_fullSample,
                          BEME, Mom, opec, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
tab_model(FutRet_t8.0, FutRet_t8.1, FutRet_t8.2, FutRet_t8.3, FutRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_FutRet_8wks.doc")
...
tab_model(DSpot_t8.0, DSpot_t8.1, DSpot_t8.2, DSpot_t8.3, DSpot_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_DSpot_8wks.doc")
...
tab_model(DOilVol_t8.0, DOilVol_t8.1, DOilVol_t8.2, DOilVol_t8.3, DOilVol_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_DOilVol_8wks.doc")
...
tab_model(xomRet_t8.0, xomRet_t8.1, xomRet_t8.2, xomRet_t8.3, xomRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_xomRet_8wks.doc")
...
tab_model(bpRet_t8.0, bpRet_t8.1, bpRet_t8.2, bpRet_t8.3, bpRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_bpRet_8wks.doc")
...
tab_model(rdsaRet_t8.0, rdsaRet_t8.1, rdsaRet_t8.2, rdsaRet_t8.3, rdsaRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_rdsaRet_8wks.doc")
...
tab_model(DInv_t8.0, DInv_t8.1, DInv_t8.2, DInv_t8.3, DInv_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_DInv_8wks.doc")
...
tab_model(DProd_t8.0, DProd_t8.1, DProd_t8.2, DProd_t8.3, DProd_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_DProd_8wks.doc")
...
tab_model(FutRet_t4.0, FutRet_t4.1, FutRet_t4.2, FutRet_t4.3, FutRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_FutRet_4wks.doc")
...
tab_model(DSpot_t4.0, DSpot_t4.1, DSpot_t4.2, DSpot_t4.3, DSpot_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_DSpot_4wks.doc")
...
#           vcov.fun = "vcovHAC", file = "opec/forwardSelection_DOilVol_4wks.doc")
...
tab_model(xomRet_t4.0, xomRet_t4.1, xomRet_t4.2, xomRet_t4.3, xomRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_xomRet_4wks.doc")
...
tab_model(bpRet_t4.0, bpRet_t4.1, bpRet_t4.2, bpRet_t4.3, bpRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_bpRet_4wks.doc")
...
tab_model(rdsaRet_t4.0, rdsaRet_t4.1, rdsaRet_t4.2, rdsaRet_t4.3, rdsaRet_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_rdsaRet_4wks.doc")
...
tab_model(DInv_t4.0, DInv_t4.1, DInv_t4.2, DInv_t4.3, DInv_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_DInv_4wks.doc")
...
tab_model(DProd_t4.0, DProd_t4.1, DProd_t4.2, DProd_t4.3, DProd_t4.4,
          ...
          vcov.fun = "vcovHAC", file = "opec/forwardSelection_DProd_4wks.doc")

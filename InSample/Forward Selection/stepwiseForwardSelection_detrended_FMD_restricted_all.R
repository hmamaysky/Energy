...
subset.prices <- dplyr::select(data.prices, c(FutRet_t4, FutRet_t8, DSpot_t4, DSpot_t8, DOilVol_t4, DOilVol_t8, 
                                              ...
                                              BEME, Mom, tone, opec, economic_growth, product_prices, gov_budget, oil_drilling, oil, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
subset.physical <- dplyr::select(data.physical, c(DInv_t4, DInv_t8, DProd_t4, DProd_t8, FutRet, DSpot, DOilVol,xomRet, bpRet, rdsaRet,
                                                  ...
                                                  VIX, vix_diff, PCAsent, PCAfreq, PCAall, BEME, Mom, tone, opec, economic_growth, product_prices, gov_budget, oil_drilling, oil, BasMom, DolBeta, InflaBeta, HedgPres, liquidity, OpenInt))
...
toLag <- c("FutRet", "DSpot", "DOilVol", "OilVol", 
           ...
           "PCAsent", "PCAfreq", "PCAall", "BEME", "Mom", "tone", "opec", "economic_growth", "product_prices", "gov_budget", "oil_drilling", "oil", "BasMom", "DolBeta", "InflaBeta", "HedgPres", "liquidity", "OpenInt")
...
tab_model(FutRet_t8.0, FutRet_t8.1, FutRet_t8.2, FutRet_t8.3, FutRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_FutRet_8wks.doc")
...
tab_model(DSpot_t8.0, DSpot_t8.1, DSpot_t8.2, DSpot_t8.3, DSpot_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_DSpot_8wks.doc")
...
tab_model(DOilVol_t8.0, DOilVol_t8.1, DOilVol_t8.2, DOilVol_t8.3, DOilVol_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_DOilVol_8wks.doc")
...
tab_model(xomRet_t8.0, xomRet_t8.1, xomRet_t8.2, xomRet_t8.3, xomRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_xomRet_8wks.doc")
...
tab_model(bpRet_t8.0, bpRet_t8.1, bpRet_t8.2, bpRet_t8.3, bpRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_bpRet_8wks.doc")
...
tab_model(rdsaRet_t8.0, rdsaRet_t8.1, rdsaRet_t8.2, rdsaRet_t8.3, rdsaRet_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_rdsaRet_8wks.doc")
...
tab_model(DInv_t8.0, DInv_t8.1, DInv_t8.2, DInv_t8.3, DInv_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_DInv_8wks.doc")
...
tab_model(DProd_t8.0, DProd_t8.1, DProd_t8.2, DProd_t8.3, DProd_t8.4,
          ...
          vcov.fun = "vcovHAC", file = "restricted_all/forwardSelection_DProd_8wks.doc")

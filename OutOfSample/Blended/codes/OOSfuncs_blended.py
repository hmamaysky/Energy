...
def data_set(d_var):
    ...
    if d_var in prices_var:
        data = pd.read_stata('data/transformed_data_prices_v19.dta').rename(columns={'date_Fri':'date', 'StkIdx_ThFr':'StkIdx'})
        ...
        data = pd.read_stata('data/transformed_data_physical_v19.dta').rename(columns={'date_Tue':'date', 'StkIdx_Tue':'StkIdx'})

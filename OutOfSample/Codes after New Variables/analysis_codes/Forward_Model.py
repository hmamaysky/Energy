...
def main(d_var):
    ...
    forward_selected_models={'FutRet':['FutRet', 'DSpot', 'WIPImom_8wk', 'basis', 'sEnv', 'OilVol', 'xomRet', 'rdsaRet'],
                             'xomRet':['xomRet', 'rdsaRet', 'sp500Ret', 'sGom', 'DOilVol', 'DInv', 'entropy', 'fCo'],
                             'bpRet':['bpRet', 'rdsaRet', 'Mom', 'xomRet', 'sEp', 'sEnv', 'fBbl', 'sGom'],
                             'rdsaRet':['rdsaRet', 'xomRet', 'bpRet', 'DInv', 'WIPImom_8wk', 'VIX', 'sEnv', 'sGom'],
                             'DSpot':['DSpot', 'FutRet', 'basis', 'WIPImom_8wk', 'sEnv', 'xomRet', 'rdsaRet', 'OilVol'],
                             'DOilVol':['DOilVol', 'OilVol', 'WIPImom_8wk', 'FutRet', 'fGom', 'VIX', 'entropy', 'bpRet'],
                             'DInv':['DInv', 'artcount', 'fRpc', 'DProd', 'entropy', 'VIX', 'HedgPres', 'basis'],
                             'DProd':['DProd', 'sEp', 'DOilVol', 'sBbl', 'BEME', 'sp500Ret','bpRet', 'fBbl']}
